...
const DeleteApproveTreeModal = ({ onClose, visible }) => {
	const selectedTree = useSelector(selectSelectedTree);

	const dispatch = useDispatch();
	const takeModActionForTree = useCallback(
		(...param) => dispatch(treeActions.takeModActionForTree(...param)),
		[dispatch]
	);
...
export default DeleteApproveTreeModal;
